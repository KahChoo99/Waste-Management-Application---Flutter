  ...
  Widget _buildList() {
    return ListView(
      children: [
        ...
        ListTile(
          title: Text('Notify me on latest news'),
          trailing: Switch.adaptive(
            value: switch4,
        ...
        ListTile(
          title: Text('Auto-update solid waste data'),
          trailing: Switch.adaptive(
            value: switch5,
        ...
        ListTile(
          title: Text('Enable sensor information on main page'),
          trailing: Switch.adaptive(
            value: switch6,
        ...
        ListTile(
          title: Text('Display Government Agency Details'),
          trailing: Switch.adaptive(
            value: switch7,
